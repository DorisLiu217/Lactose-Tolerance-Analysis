              ...
              fluidPage(
                sidebarLayout(
                  sidebarPanel(
                    ...
                    selectInput('colMissingPercent', 'Drop colums with selected percentage of missing values', c(100, 90, 80, 70, 60, 50, 40, 30, 20, 10), selected = 90),
                    selectInput('rowMissingPercent', 'Drop rows with selected percentage of missing values', c(100, 90, 80, 70, 60, 50, 40, 30, 20, 10), selected = 50),
...
server <- function(input, output, session){
  dataset <- reactive({
    ...
    filePath = "/Users/chiralmehta/cmehta/00_Chiral_Masters/HS_630_ShinyProject/two_label_with_selected_features_rn_v3.csv"
